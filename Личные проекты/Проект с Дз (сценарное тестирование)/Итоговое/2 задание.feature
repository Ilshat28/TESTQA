...
Функционал: _0901 Отчет (Остатки) тестирование
...
Сценарий: _0901 Отчет (Остатки) тестирование
...
*Проверка Что отчет заполнился
	И я жду когда в табличном документе "Результат" заполнится ячейка "R3C6" в течение 2 секунд	
*Проверка макетов
	Дано Табличный документ "Результат" равен макету "Остатки_отчет1" по шаблону
...
// Минусы в отчете - это не баг логики 1с. Это баг аналитики ведения складского учета.

	И в табличном документе "РеквизитТабличныйДокумент" я перехожу к ячейке "АдресЯчейки"
