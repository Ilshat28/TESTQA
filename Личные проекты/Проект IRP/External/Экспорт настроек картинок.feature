...
// файл для настроек картинок от преподователя
Сценарий: экспорт настроек картинок
	...
	И я перезаполняю для объекта табличную часть "ConnectionSetting":
		| 'Ref'                                                                         | 'Key'         | 'Value'                                                                                                                  |
		| 'e1cib/data/Catalog.IntegrationSettings?ref=b772dbcd8801bc7611ec420177a49494' | 'AddressPath' | 'C:\Users\stali\OneDrive\Рабочий стол\030 Дополнительные методические материалы\Методические материалы к Модулю 4\Files' |
		| 'e1cib/data/Catalog.IntegrationSettings?ref=b772dbcd8801bc7611ec420177a49495' | 'AddressPath' | 'C:\Users\stali\OneDrive\Рабочий стол\030 Дополнительные методические материалы\Методические материалы к Модулю 4\Files' |
